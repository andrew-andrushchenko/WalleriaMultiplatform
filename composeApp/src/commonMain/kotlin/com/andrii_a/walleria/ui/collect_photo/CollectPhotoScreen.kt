...
import walleriamultiplatform.composeapp.generated.resources.create_new_and_add
import walleriamultiplatform.composeapp.generated.resources.navigate_back
import walleriamultiplatform.composeapp.generated.resources.select_collections
    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = { Text(text = stringResource(Res.string.select_collections)) },
                navigationIcon = {
        ...
        floatingActionButton = {
            ExtendedFloatingActionButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(Res.string.create_new_and_add),
                )

                Spacer(modifier = Modifier.width(8.dp))

                Text(text = stringResource(Res.string.create_new_and_add))
            }
        },
