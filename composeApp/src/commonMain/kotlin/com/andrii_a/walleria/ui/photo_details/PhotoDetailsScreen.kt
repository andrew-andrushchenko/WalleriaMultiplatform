...
@Composable
expect fun PlatformToolbarWrapper(
                    ...
                    when (state.value) {
                        ...
                        is AsyncImagePainter.State.Error -> {
                            Box(
                                ...
                                ErrorBanner(
                                    message = stringResource(Res.string.error_banner_text),
...
@Composable
expect fun MobileFormFactorStatusBarMutableColorDisposableEffect(currentImageScale: Float)
...
private fun TopBar(
    ...
    MobileFormFactorStatusBarMutableColorDisposableEffect(currentImageScale)
