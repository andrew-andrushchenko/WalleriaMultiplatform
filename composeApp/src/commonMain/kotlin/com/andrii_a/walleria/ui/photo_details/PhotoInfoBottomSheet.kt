...
import walleriamultiplatform.composeapp.generated.resources.details
import walleriamultiplatform.composeapp.generated.resources.downloads
import walleriamultiplatform.composeapp.generated.resources.exif_info
import walleriamultiplatform.composeapp.generated.resources.likes
import walleriamultiplatform.composeapp.generated.resources.location
import walleriamultiplatform.composeapp.generated.resources.no_description_provided
import walleriamultiplatform.composeapp.generated.resources.related_collections
import walleriamultiplatform.composeapp.generated.resources.resolution_formatted
import walleriamultiplatform.composeapp.generated.resources.topic_photos_formatted
import walleriamultiplatform.composeapp.generated.resources.unknown
import walleriamultiplatform.composeapp.generated.resources.views
...
fun PhotoInfoBottomSheet(
    ...
    Column(
        ...
        Text(
            text = photo.description ?: stringResource(Res.string.no_description_provided),
        ...
        photo.relatedCollections?.let {
            it.results?.let { collections ->
                Text(
                    text = stringResource(Res.string.related_collections),
                    style = MaterialTheme.typography.titleSmall,
                    fontWeight = FontWeight.SemiBold,
                    maxLines = 1,
                    overflow = TextOverflow.Ellipsis,
    ...
    Column(modifier = modifier) {
        PhotoInfoItem(
            ...
            text = buildAnnotatedString {
                append(photo.location?.locationString ?: stringResource(Res.string.unknown))
            },
        ...
        PhotoInfoItem(
            ...
            text = buildAnnotatedString {
                ...
                append(
                    stringResource(
                        Res.string.resolution_formatted,
                        photo.width,
                        photo.height
                    )
                )
        ...
        PhotoInfoItem(
            title = stringResource(Res.string.likes),
            text = buildAnnotatedString { append(photo.likes.abbreviatedNumberString) },
            icon = Icons.Filled.Favorite
        )

        PhotoInfoItem(
            title = stringResource(Res.string.views),
    ...
    Card(
        ...
        Box(contentAlignment = Alignment.Center) {
            ...
            Column(
                ...
                Text(
                    text = stringResource(
                        Res.string.topic_photos_formatted,
