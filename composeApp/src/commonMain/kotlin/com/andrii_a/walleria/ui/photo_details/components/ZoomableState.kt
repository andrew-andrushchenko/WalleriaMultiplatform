...
class ZoomableState(
    ...
    fun calculateTargetTranslation(centroid: Offset): Offset =
    ...
    suspend fun onTransform(centroid: Offset, pan: Offset, zoom: Float) {
    ...
    fun onDismissDrag(dragAmountY: Float) {
        dismissDragAbsoluteOffsetY += dragAmountY
    }

    suspend fun onDismissDragEnd() {
        animate(
...
class HorizontalEdge private constructor(private val value: Int) {
