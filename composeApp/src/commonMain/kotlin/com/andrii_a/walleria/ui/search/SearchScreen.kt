...
import walleriamultiplatform.composeapp.generated.resources.clear_history
...
import walleriamultiplatform.composeapp.generated.resources.photo_filters
import walleriamultiplatform.composeapp.generated.resources.photos
import walleriamultiplatform.composeapp.generated.resources.search_history
import walleriamultiplatform.composeapp.generated.resources.search_history_empty_text
import walleriamultiplatform.composeapp.generated.resources.type_something
import walleriamultiplatform.composeapp.generated.resources.users
                    ...
                    AnimatedVisibility(
                        ...
                        IconButton(onClick = { onEvent(SearchEvent.OpenFilterDialog) }) {
                            Icon(
                                ...
                                contentDescription = stringResource(Res.string.photo_filters)
                            )
                        }
                    }
                },
        ...
        topBar = {
            ...
            ExpandedFullScreenSearchBar(
                ...
                if (state.searchHistory.isEmpty()) {
                    Text(
                        text = stringResource(Res.string.search_history_empty_text),
...
private enum class SearchScreenTabs(val titleRes: StringResource) {
    Photos(Res.string.photos),
    Collections(Res.string.collections),
    Users(Res.string.users)
}
