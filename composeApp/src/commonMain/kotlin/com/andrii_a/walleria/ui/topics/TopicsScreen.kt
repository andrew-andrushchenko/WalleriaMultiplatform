...
import walleriamultiplatform.composeapp.generated.resources.topics_title_template
        ...
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(
                        text = stringResource(
                            Res.string.topics_title_template,
                            stringResource(state.topicsDisplayOrder.titleRes)
                        )
                    )
                },
                navigationIcon = {
