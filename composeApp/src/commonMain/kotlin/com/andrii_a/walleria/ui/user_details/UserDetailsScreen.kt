...
import walleriamultiplatform.composeapp.generated.resources.edit_collection
import walleriamultiplatform.composeapp.generated.resources.liked_photos
import walleriamultiplatform.composeapp.generated.resources.more_about_profile
import walleriamultiplatform.composeapp.generated.resources.navigate_back
import walleriamultiplatform.composeapp.generated.resources.open_in_browser
                    ...
                    Box(modifier = Modifier) {
                        ...
                        IconButton(
                            ...
                            Icon(
                                ...
                                contentDescription = stringResource(Res.string.more_about_profile)
                            )
                        }
                        ...
                        DropdownMenu(
                            ...
                            DropdownMenuItem(
                                text = {
                                    Text(text = stringResource(Res.string.more_about_profile))
                                },
                                onClick = {
...
private enum class UserDetailsScreenTabs(val titleRes: StringResource) {
    Photos(Res.string.photos),
    LikedPhotos(Res.string.liked_photos),
